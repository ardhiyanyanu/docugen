...
public class JodConverterLocalProperties {
    ...
    public @Nullable Map<@NotNull String, @NotNull DocumentFormatProperties> getFormatOptions() {
        return formatOptions;
    }

    public void setFormatOptions(
            final @Nullable Map<@NotNull String, @NotNull DocumentFormatProperties> formatOptions) {
